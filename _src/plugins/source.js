...
(function (){
    var sourceEditors = {
        ...
        codemirror: function (editor, holder){
            ...
            dom.style.cssText = 'position:relative;left:0;top:0;width:100%;font-family:consolas,"Courier new",monospace;font-size:13px;';
            codeEditor.getScrollerElement().style.cssText = 'position:relative;left:0;top:0;width:100%;';
            codeEditor.refresh();
            return {
        ...
        if(opt.sourceEditor == "codemirror"){
            ...
            me.addListener("ready",function(){
                utils.loadFile(document,{
                    src : opt.codeMirrorJsUrl || opt.UEDITOR_HOME_URL + "third-party/codemirror/codemirror.min.js",
                    tag : "script",
                ...
                utils.loadFile(document,{
                    ...
                    rel : "stylesheet",
                    type : "text/css",
                    href : opt.codeMirrorCssUrl || opt.UEDITOR_HOME_URL + "third-party/codemirror/codemirror.min.css"
                });
