            ...
            function createTable(opt, tdWidth) {
                ...
                for (var r = 0; r < rowsNum; r++) {
                    ...
                    for (var c = 0; c < colsNum; c++) {
                        html.push('<td width="' + tdWidth + '"  vAlign="' + opt.tdvalign + '" style="border: 1px solid">' + (browser.ie && browser.version < 11 ? domUtils.fillChar : '<br/>') + '</td>')
                    }
                    html.push('</tr>')
                }
                //禁止指定table-width
                return '<table style="border-spacing: 0px;border-collapse: collapse; background-color: #ffffff"><tbody>' + html.join('') + '</tbody></table>'
            }
